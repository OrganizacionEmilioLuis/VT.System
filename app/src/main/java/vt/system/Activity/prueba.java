...
import vt.system.Activity.api.AppConfig;
import vt.system.Activity.api.ApiConfig;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try {
            ...
            if (requestCode == 0 && resultCode == RESULT_OK && null != data) {
                ...
                imgView.setImageBitmap(getThumbnailPathForLocalFile(prueba.this, selectedVideo));
                cursor.close();
